...
import { DeleteAccountPayload, TUser } from './user.interface';
import { User } from '../src/app/modules/user/user.models';
...
const createUserToken = async (payload: TUser) => {
...
const otpVerifyAndCreateUser = async ({
  ...
  const { password, email, name, role, phone } = decodeData;
