...
auth_controller_1.authControllers.forgotPassword)
    .patch('/change-password', (0, auth_1.default)(user_constants_1.USER_ROLE.ADMIN, user_constants_1.USER_ROLE.CUSTOMER), auth_controller_1.authControllers.changePassword)
    .patch('/forgot-password-otp-match', 
